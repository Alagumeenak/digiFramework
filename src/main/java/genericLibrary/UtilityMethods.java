...
public class UtilityMethods implements FrameworkConstants {
	...
	public static void selectOptionByIndex(WebElement dropdwon,int index)
	{
		Select select=new Select(dropdwon);
		select.selectByIndex(index);
	}
	public static void selectOptionByValue(WebElement dropdwon,String value )
	{
		Select select=new Select(dropdwon);
		select.selectByValue(value);
	}
	public static void selectOptionByVisibletext(WebElement dropdwon,String text)
	{
		Select select=new Select(dropdwon);
    ...
    public static void handleDisabledTextField(WebElement element, String value) {
    ...
    public static void scrollFromOrigin(WebElement element, int x,int y) {
    	...
    	action.scrollFromOrigin(origin, x, y);
    }
